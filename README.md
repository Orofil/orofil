...
[![My skills](https://skillicons.dev/icons?i=py,java,cpp,rust,idea,vscode,maven,mysql,supabase,postgres,androidstudio,r,powershell,html,css,bootstrap,js,jquery,react,vite,nodejs,nextjs,tailwind,git,godot,blender,latex,windows,linux,ubuntu&perline=6)](https://skillicons.dev)
